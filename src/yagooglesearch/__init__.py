...
class SearchClient:
	...
	def update_urls(self):
		...
		self.url_search = (
			f"https://www.google.{self.tld}/search?hl={self.lang_html_ui}&"
	...
	def get_page(self, url):
		...
		if http_response_code == 200:
			html = response.text
			if "If you're having trouble accessing Google Search, please" in html:
				ROOT_LOGGER.info("If you're having trouble accessing Google Search, please.")
